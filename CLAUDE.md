...
- Bootstrap clones top-level repositories by default and reuses existing registry checkouts as Git object references; use `--submodules` only when recursive submodule checkout is needed.
